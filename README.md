...
- `docs/agent-skills.md`: repo-managed agent skills workflow
...
Install the repo-managed agent skills locally if you want to reuse the project-specific maintenance skills:
